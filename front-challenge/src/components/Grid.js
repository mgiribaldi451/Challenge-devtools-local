...
/**
 * 
 *  Configuracion del componente grilla que va a rendereciciarse al iniciar
 *  
 */
...
function handleErrors(response) {
  ...
  return response;
}                                                           //Definicion y control para tener el datasource para hacer la consulta y completar la grilla
