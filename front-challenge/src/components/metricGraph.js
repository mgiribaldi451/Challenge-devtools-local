...
/**
 *  Configuracion del componente que muestra la grafica del top 3 
 * 
 * 
 */
...
function handleErrors(response) {
    ...
    return response;
  }                                                    //Definicion y control para tener el datasource para hacer la consulta y poder mostrar grafico
